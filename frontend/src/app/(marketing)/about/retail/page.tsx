  ...
  return (
    ...
    >
      ...
      >
        ...
        <rect x="40" y="100" width="168" height="240" rx="6" fill="url(#bldg1)" stroke="rgba(96,165,250,0.25)" strokeWidth="1" />
        <rect x="40" y="100" width="168" height="8" rx="3" fill="#1A56DB" opacity="0.75" />
        <rect x="56" y="118" width="136" height="78" rx="4" fill="rgba(26,86,219,0.07)" stroke="rgba(96,165,250,0.16)" strokeWidth="1" />
        <rect x="68" y="128" width="112" height="30" rx="4" fill="rgba(26,86,219,0.28)" stroke="rgba(96,165,250,0.48)" strokeWidth="1" />
        <rect x="80" y="136" width="40" height="4" rx="2" fill="rgba(96,165,250,0.75)" style={{ animation: "gmSignPulse 2.5s ease-in-out infinite" }} />
        <rect x="80" y="144" width="28" height="3" rx="1.5" fill="rgba(96,165,250,0.38)" />
        <rect x="130" y="135" width="36" height="9" rx="3" fill="#60A5FA" opacity="0.9" style={{ animation: "gmSignPulse 2.5s 0.4s ease-in-out infinite" }} />
        <path d="M36 208 L212 208 L206 233 L42 233 Z" fill="url(#awn1)" opacity="0.92" style={{ transformOrigin: "124px 208px", animation: "gmAwning 3s ease-in-out infinite" }} />
        ...
        <rect x="50" y="244" width="90" height="84" rx="4" fill="url(#winGrad1)" stroke="rgba(96,165,250,0.4)" strokeWidth="1.5" />
        <rect x="54" y="248" width="12" height="72" rx="2" fill="rgba(255,255,255,0.06)" />
        <rect x="50" y="244" width="90" height="84" rx="4" fill="rgba(96,165,250,0.07)" style={{ animation: "gmWinGlow 2.8s ease-in-out infinite" }} />
        ...
        <ellipse cx="48" cy="237" rx="5" ry="3" fill="#60A5FA" opacity="0.75" style={{ animation: "gmLamp 2s ease-in-out infinite" }} />
        <rect x="203" y="237" width="5" height="14" rx="2" fill="rgba(96,165,250,0.5)" />
        <ellipse cx="205" cy="237" rx="5" ry="3" fill="#60A5FA" opacity="0.75" style={{ animation: "gmLamp 2s 0.3s ease-in-out infinite" }} />
        <rect x="185" y="78" width="166" height="262" rx="6" fill="url(#bldg2)" stroke="rgba(52,211,153,0.22)" strokeWidth="1" />
        <rect x="185" y="78" width="166" height="8" rx="3" fill="#059669" opacity="0.78" />
        <rect x="200" y="96" width="136" height="84" rx="4" fill="rgba(5,150,105,0.06)" stroke="rgba(52,211,153,0.15)" strokeWidth="1" />
        <rect x="212" y="106" width="112" height="32" rx="4" fill="rgba(5,150,105,0.26)" stroke="rgba(52,211,153,0.5)" strokeWidth="1" />
        <rect x="224" y="114" width="44" height="4" rx="2" fill="rgba(52,211,153,0.78)" style={{ animation: "gmSignPulse 2.5s 0.8s ease-in-out infinite" }} />
        <rect x="224" y="122" width="30" height="3" rx="1.5" fill="rgba(52,211,153,0.38)" />
        <rect x="276" y="113" width="34" height="9" rx="3" fill="#34D399" opacity="0.9" style={{ animation: "gmSignPulse 2.5s 1.2s ease-in-out infinite" }} />
        <path d="M181 212 L355 212 L349 237 L187 237 Z" fill="url(#awn2)" opacity="0.92" style={{ transformOrigin: "268px 212px", animation: "gmAwning 3.4s 0.5s ease-in-out infinite" }} />
        ...
        <rect x="194" y="248" width="94" height="92" rx="4" fill="url(#winGrad2)" stroke="rgba(52,211,153,0.38)" strokeWidth="1.5" />
        <rect x="198" y="252" width="13" height="80" rx="2" fill="rgba(255,255,255,0.06)" />
        <rect x="194" y="248" width="94" height="92" rx="4" fill="rgba(52,211,153,0.06)" style={{ animation: "gmWinGlow 3s 0.6s ease-in-out infinite" }} />
        ...
        <ellipse cx="193" cy="241" rx="5" ry="3" fill="#34D399" opacity="0.75" style={{ animation: "gmLamp 2.2s 0.1s ease-in-out infinite" }} />
        <rect x="349" y="241" width="5" height="14" rx="2" fill="rgba(52,211,153,0.5)" />
        <ellipse cx="351" cy="241" rx="5" ry="3" fill="#34D399" opacity="0.75" style={{ animation: "gmLamp 2.2s 0.5s ease-in-out infinite" }} />
        <rect x="330" y="108" width="170" height="232" rx="6" fill="url(#bldg3)" stroke="rgba(129,140,248,0.22)" strokeWidth="1" />
        <rect x="330" y="108" width="170" height="8" rx="3" fill="#4F46E5" opacity="0.72" />
        <rect x="346" y="126" width="138" height="80" rx="4" fill="rgba(79,70,229,0.06)" stroke="rgba(129,140,248,0.14)" strokeWidth="1" />
        <rect x="358" y="136" width="114" height="30" rx="4" fill="rgba(79,70,229,0.26)" stroke="rgba(129,140,248,0.46)" strokeWidth="1" />
        <rect x="370" y="144" width="38" height="4" rx="2" fill="rgba(129,140,248,0.78)" style={{ animation: "gmSignPulse 2.5s 1.6s ease-in-out infinite" }} />
        <rect x="370" y="152" width="26" height="3" rx="1.5" fill="rgba(129,140,248,0.38)" />
        <rect x="418" y="143" width="40" height="9" rx="3" fill="#818CF8" opacity="0.9" style={{ animation: "gmSignPulse 2.5s 2s ease-in-out infinite" }} />
        <path d="M326 218 L504 218 L498 243 L332 243 Z" fill="url(#awn3)" opacity="0.92" style={{ transformOrigin: "415px 218px", animation: "gmAwning 2.8s 1s ease-in-out infinite" }} />
        ...
        <rect x="340" y="254" width="90" height="84" rx="4" fill="url(#winGrad3)" stroke="rgba(129,140,248,0.35)" strokeWidth="1.5" />
        <rect x="344" y="258" width="12" height="72" rx="2" fill="rgba(255,255,255,0.06)" />
        <rect x="340" y="254" width="90" height="84" rx="4" fill="rgba(129,140,248,0.06)" style={{ animation: "gmWinGlow 3.2s 1.2s ease-in-out infinite" }} />
        ...
        <ellipse cx="338" cy="247" rx="5" ry="3" fill="#818CF8" opacity="0.75" style={{ animation: "gmLamp 1.9s 0.7s ease-in-out infinite" }} />
        <rect x="494" y="247" width="5" height="14" rx="2" fill="rgba(129,140,248,0.5)" />
        <ellipse cx="496" cy="247" rx="5" ry="3" fill="#818CF8" opacity="0.75" style={{ animation: "gmLamp 1.9s 1.1s ease-in-out infinite" }} />
        ...
        <g style={{ animation: "gmBadgeFloat 3.2s 1.8s ease-in-out infinite" }}>
          <rect x="188" y="12" width="158" height="48" rx="10" fill="rgba(8,18,60,0.93)" stroke="rgba(129,140,248,0.45)" strokeWidth="1" />
          ...
          <text x="200" y="49" fontSize="17" fontWeight="700" fill="#818CF8" fontFamily="'Inter',sans-serif">IDR 4.2B</text>
        ...
        <line x1="267" y1="60" x2="267" y2="78" stroke="rgba(129,140,248,0.2)" strokeWidth="1" strokeDasharray="4 3" />
        <line x1="470" y1="72" x2="416" y2="108" stroke="rgba(52,211,153,0.2)" strokeWidth="1" strokeDasharray="4 3" />
      </svg>
      <style>{`
...
const challenges = [
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        <path d="M3 20h18" stroke="#0891B2" strokeWidth="2" strokeLinecap="round" />
        <rect x="4" y="12" width="4" height="8" rx="1" fill="#0891B2" opacity="0.4" />
        <rect x="10" y="7" width="4" height="13" rx="1" fill="#0891B2" opacity="0.7" />
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="12" r="9" stroke="#059669" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.4" />
        <circle cx="12" cy="12" r="5" stroke="#059669" strokeWidth="1.5" opacity="0.7" />
        <path d="M12 7v10M7 12h10" stroke="#059669" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
  ...
  return (
    ...
    >
        ...
        >
          <div style={{ animation: "gmFadeUp 0.8s ease both" }}>
            ...
            >
              ...
              <span style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: 11, fontWeight: 600, color: "#93C5FD", letterSpacing: "0.07em", textTransform: "uppercase" }}>Retail</span>
            </div>
            <h1
              style={{
                fontFamily: "'Inter',system-ui,sans-serif",
            ...
            >
              Optimize Store{" "}
              <span style={{ background: "linear-gradient(90deg, #60A5FA, #34D399)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Performance</span>
              <br />
        ...
        <div className="cs-container">
          <div style={{ marginBottom: 64, maxWidth: 560 }}>
            ...
            >
              ...
              <span style={{ fontFamily: "'Inter',sans-serif", fontSize: 11, fontWeight: 700, color: "#1A56DB", letterSpacing: "0.07em", textTransform: "uppercase" }}>Challenges & Solutions</span>
            </div>
            <h2
              style={{
                fontFamily: "'Inter',sans-serif",
      ...
      <style>{`
        ...
        /* Challenge row: problem | arrow | solution */
        .cs-row {
          display: grid;
        ...
        @media (max-width: 900px) {
          ...
          /* Scale down the SVG illustration a bit */
          .gm-hero-grid > div:last-child {
            max-width: 460px;
            margin: 0 auto;
          }
        ...
        @media (max-width: 480px) {
          ...
          .cs-row > div:first-child,
          .cs-row > div:last-child {
        ...
        @media (max-width: 390px) {
          .gm-hero-grid {
            padding: 3.5rem 0.875rem 1.75rem !important;
          ...
          .cs-row > div:first-child p,
          .cs-row > div:last-child p {
