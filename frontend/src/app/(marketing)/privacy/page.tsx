    ...
    >
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 2,
                  animation: `ppBarPulse 2.5s ${i * 0.4}s ease-in-out infinite`,
                }}
              />
            </div>
          </div>
      ...
      <div
        style={{
          ...
          minWidth: 120,
          zIndex: 10,
          animation: "ppFloatCard 4s 0.4s ease-in-out infinite",
      ...
      <div
        style={{
          ...
          minWidth: 138,
          zIndex: 10,
          animation: "ppFloatCard 4.5s 1s ease-in-out infinite",
          boxShadow: "0 8px 32px rgba(0,0,0,0.3)",
        }}
      >
        <div
      ...
      <div
        style={{
          ...
          WebkitBackdropFilter: "blur(16px)",
          zIndex: 10,
          animation: "ppFloatCard 3.8s 1.6s ease-in-out infinite",
          boxShadow: "0 8px 32px rgba(0,0,0,0.3)",
          display: "flex",
          alignItems: "center",
          gap: 6,
    ...
    <section className="pp-hero">
      ...
      {[
        ...
        <span
          ...
          style={{
            ...
            animation: `ppBlink 3s ${p.d} infinite`,
            pointerEvents: "none",
          }}
        />
      ))}
      ...
      <div className="pp-container">
        <div className="pp-hero-inner">
          <div
            style={{
              animation: "ppFadeUp 0.8s ease both",
              position: "relative",
              zIndex: 2,
            }}
          >
            ...
            >
              ...
              Geomarketia collects, uses, and protects your personal data when
              you use our geospatial analytics platform.
            </p>
          </div>

          <div
            style={{
              animation: "ppFadeUp 0.8s 0.2s ease both",
              position: "relative",
              zIndex: 2,
            }}
          >
      ...
      <div className="pp-container">
        <div ref={titleRef} className="pp-content-header">
          ...
          <h2 className="pp-section-title">
            <span style={{ color: "#1A56DB" }}>How We </span>
            <span
              style={{
                background: "linear-gradient(90deg, #60A5FA, #34D399)",
                WebkitBackgroundClip: "text",
            ...
            <span style={{ color: "#1A56DB" }}> Your Data</span>
          </h2>
          <p className="pp-section-sub">
            We are committed to transparency and responsible data handling. Read
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pp-container { max-width: 1140px; margin: 0 auto; padding: 0 3.5rem; position: relative; z-index: 1; }
        .pp-hero .pp-container { max-width: unset; padding: 0; width: 100%; }
        ...
        .pp-hero-inner { display: grid; grid-template-columns: 1fr 1fr; gap: 64px; align-items: center; max-width: 1440px; margin: 0 auto; padding: 6rem 3.5rem 4rem; }
        ...
        @media (max-width: 900px) { .pp-hero-inner { grid-template-columns: 1fr; gap: 40px; padding: 5rem 1.5rem 3rem; } }
        @media (max-width: 640px) { .pp-hero-inner { padding: 5rem 1.25rem 3rem; } .pp-container { padding: 0 20px; } }
      `}</style>
    </>
  );
}
