    ...
    >
        ...
        {[100, 85, 90, 70, 80, 60].map((w, i) => (
          <div
            ...
            style={{
              ...
              width: `${w}%`,
              background:
                i % 3 === 0 ? "rgba(37,99,235,0.6)" : "rgba(255,255,255,0.12)",
              borderRadius: 2,
              marginBottom: 8,
              animation: `tcLinePulse 2.5s ${i * 0.3}s ease-in-out infinite`,
            }}
          />
        ))}
        <div
      ...
      <div
        style={{
          ...
          minWidth: 120,
          zIndex: 10,
          animation: "tcFloatCard 4s 0.4s ease-in-out infinite",
      ...
      <div
        style={{
          ...
          minWidth: 138,
          zIndex: 10,
          animation: "tcFloatCard 4.5s 1s ease-in-out infinite",
          boxShadow: "0 8px 32px rgba(0,0,0,0.3)",
        }}
      >
        <div
      ...
      <div
        style={{
          ...
          WebkitBackdropFilter: "blur(16px)",
          zIndex: 10,
          animation: "tcFloatCard 3.8s 1.6s ease-in-out infinite",
          boxShadow: "0 8px 32px rgba(0,0,0,0.3)",
          display: "flex",
          alignItems: "center",
          gap: 6,
      ...
      {[
        ...
        <span
          ...
          style={{
            ...
            animation: `tcBlink 3s ${p.d} infinite`,
            pointerEvents: "none",
          }}
        />
      ))}
      ...
      <div className="tc-container">
        <div className="tc-hero-inner">
          ...
          >
            ...
            >
              Please read these terms carefully before using our Geomarketia
              platform. By accessing our services, you agree to be bound by the
          ...
          <div
            style={{
              animation: "tcFadeUp 0.8s 0.2s ease both",
              position: "relative",
              zIndex: 2,
            }}
          >
      ...
      <div className="tc-container">
        <div ref={titleRef} className="tc-content-header">
          ...
          <h2 className="tc-section-title">
            <span style={{ color: "#1A56DB" }}>Our </span>
            <span
              style={{
                background: "linear-gradient(90deg, #60A5FA, #34D399)",
                WebkitBackgroundClip: "text",
            ...
            <span style={{ color: "#1A56DB" }}> with You</span>
          </h2>
          <p className="tc-section-sub">
            These terms govern your use of Geomarketia's platform and services.
            ...
            <div className="tc-sidebar-card">
              ...
              {sections.map((section, i) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
                  className={`tc-nav-item${activeSection === section.id ? " tc-nav-item-active" : ""}`}
                  onClick={() => setActiveSection(section.id)}
                >
                  <span className="tc-nav-num">
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tc-container { max-width: 1140px; margin: 0 auto; padding: 0 3.5rem; position: relative; z-index: 1; }
        ...
        .tc-hero-inner { display: grid; grid-template-columns: 1fr 1fr; gap: 64px; align-items: center; max-width: 1440px; margin: 0 auto; padding: 6rem 3.5rem 4rem; }
        .tc-hero .tc-container { max-width: unset; padding: 0; width: 100%; }
        ...
        @media (max-width: 900px) { .tc-hero-inner { grid-template-columns: 1fr; gap: 40px; padding: 5rem 1.5rem 3rem; } }
        @media (max-width: 640px) { .tc-hero-inner { padding: 5rem 1.25rem 3rem; } }      `}</style>
    </>
  );
}
