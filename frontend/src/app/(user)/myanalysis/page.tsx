...
export default function MyAnalysisPage() {
  const [activeFilter, setActiveFilter] = useState<"All" | AnalysisStatus>(
    "All",
  );
  ...
  const filters: ("All" | AnalysisStatus)[] = [
    "All",
    "Completed",
    "Processing",
    "Draft",
  ...
  const stats = {
    ...
    locations: new Set(
      mockAnalyses.map((a) => a.location.split(",")[1]?.trim()),
    ).size,
  };
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 max-w-lg">
          {[
            ...
            >
              ...
              <p className="text-2xl font-bold" style={{ color: "#1A56DB" }}>
                {s.value}
              </p>
