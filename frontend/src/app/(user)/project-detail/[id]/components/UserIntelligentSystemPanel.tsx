...
function RankListItem({
  ...
  return (
    ...
    >
      ...
      >
        <CompactMetric label="Recommended" value={businessName} />
...
export default function UserIntelligentSystemPanel({
  selectedItem,
  category,
  recommendations,
  loading,
          ...
          >
            {selectedItem ? (
              ...
              <div style={{ padding: "12px", flex: 1, overflowY: "auto" }}>
                ...
                >
                  <DetailRow label="Recommended" value={selectedBusinessName} />
                  <DetailRow
                    label="Ranking"
