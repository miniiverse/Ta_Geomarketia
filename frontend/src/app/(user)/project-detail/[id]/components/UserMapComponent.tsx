...
import UserMapStatsCard from "./UserMapStatsCard";
import { UserMapSidebar, UserClusterSummaryCard } from "./UserMapSidebar";
...
function RadiusSelector({
  ...
  return (
    ...
    >
      <style>{`
        .user-radius-slider { -webkit-appearance: none; appearance: none; width: 100%; height: 4px; border-radius: 4px; outline: none; cursor: pointer; background: linear-gradient(to right, #1A56DB ${pct}%, #e2e8f0 ${pct}%); transition: background 0s; }
        .user-radius-slider::-webkit-slider-thumb { -webkit-appearance: none; appearance: none; width: 16px; height: 16px; border-radius: 50%; background: #1A56DB; border: 2.5px solid #fff; box-shadow: 0 0 0 2px #1A56DB, 0 1px 4px rgba(26,86,219,0.3); cursor: grab; transition: box-shadow 0.15s ease, transform 0.1s ease; }
        .user-radius-slider:active::-webkit-slider-thumb { cursor: grabbing; transform: scale(1.2); box-shadow: 0 0 0 5px rgba(26,86,219,0.15), 0 1px 4px rgba(26,86,219,0.3); }
        .user-radius-slider::-moz-range-thumb { width: 16px; height: 16px; border-radius: 50%; background: #1A56DB; border: 2.5px solid #fff; box-shadow: 0 0 0 2px #1A56DB; cursor: grab; }
        @keyframes user-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
      `}</style>
      <div
        style={{
          display: "flex",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          {isLoading && (
            <svg
              ...
              strokeWidth="2.5"
              strokeLinecap="round"
              style={{ animation: "user-spin 1s linear infinite" }}
            >
