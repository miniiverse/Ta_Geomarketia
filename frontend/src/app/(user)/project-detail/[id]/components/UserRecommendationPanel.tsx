    ...
    >
      ...
      >
        <Metric
          ...
          value={formatMetric(item.features?.business_density_500m, " / 500m")}
        />
        <Metric
          label="Road Access"
          value={
        ...
        <Metric
          ...
          value={formatMetric(item.features?.nearest_road_distance_m, " m")}
        />
        <Metric
          label="Population"
          value={formatMetric(item.features?.population_density)}
        />
      </div>
...
export default function UserRecommendationPanel({
  selectedGroup,
  category,
  recommendations,
  loadingAnalysis,
    ...
    >
      ...
      <div
        style={{
          flex: 1,
          overflowY: "auto",
          padding: analysisTriggered ? "12px" : 0,
        }}
      >
        {!analysisTriggered && (
          <EmptyState
        ...
        {analysisTriggered && loadingAnalysis && (
          ...
          >
            ...
            <div style={{ fontSize: "12px", color: "#64748b" }}>
              Fetching business recommendations...
            </div>
          </div>
        )}
