...
function computeSummary(recommendations: RecommendationItem[]) {
  ...
  const avgScore =
    total > 0
      ? recommendations.reduce((sum, item) => sum + (item.score || 0), 0) /
        total
      : 0;
  ...
  const bandCounts = recommendations.reduce<Record<string, number>>(
    (acc, item) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ minWidth: 0 }}>
        <div
          style={{ fontSize: "11px", color: "#64748b", marginBottom: "1px" }}
        >
          {label}
        </div>
        <div
...
export default function UserRecommendationSummaryCard({
  category,
  recommendations,
  loadingAnalysis,
  analysisError,
      ...
      >
        ...
        {loadingAnalysis && (
          ...
          >
            ...
            <span
              style={{ fontSize: "11px", fontWeight: 600, color: "#1A56DB" }}
            >
          ...
          >
            ...
            >
              <div>
                ...
                >
                  {summary.highCount} of {summary.total} locations are in the
                  High category
                </div>
              </div>
              <span
