  ...
  return (
    <>
      <style>{`
        ...
        /* ── Stat cards inside detail tab: 3 col default ── */
        .td-stat-grid {
          display: grid;
        ...
        /* ── Invoice billing grid: 2 col default ── */
        .td-billing-grid {
          display: grid;
        ...
        @media (max-width: 768px) {
          ...
          .td-billing-grid > div:last-child { text-align: left !important; }
          .td-footer   { padding: 12px 20px; }
        }

        /* ── Mobile (≤480px) ── */
        @media (max-width: 480px) {
          .td-header   { padding: 16px 14px 14px; }
          .td-project-title { font-size: 16px; }
          .td-meta     { font-size: 12px; }
          .td-stat-grid { grid-template-columns: 1fr; gap: 10px; }
          .td-body      { padding: 16px 14px !important; }
          .td-footer    { padding: 12px 14px; flex-direction: column; }
          .td-footer button { width: 100%; justify-content: center; }
          .td-tab-btn   { padding: 7px 10px !important; font-size: 11.5px !important; }
          .td-tab-btn span { display: none; } /* hide tab label text on very small, keep icon */
        }
      `}</style>
          ...
          <div className="td-header">
            <div className="td-header-top">
              <div>
                ...
                <h2 className="td-project-title">{transaction.projectName}</h2>
                <p className="td-meta">
                  {transaction.date} · via {transaction.payment} ·{" "}
                  {transaction.amount}
                </p>
              </div>
              <button
