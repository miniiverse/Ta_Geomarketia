    ...
    >
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 360 300"
        >
          <line x1="137" y1="84" x2="209" y2="135" stroke="#60A5FA" strokeWidth="1" strokeDasharray="4 4" />
          <line x1="137" y1="84" x2="79" y2="165" stroke="#60A5FA" strokeWidth="1" strokeDasharray="4 4" />
          <line x1="209" y1="135" x2="252" y2="66" stroke="#60A5FA" strokeWidth="1" strokeDasharray="4 4" />
          <line x1="79" y1="165" x2="209" y2="135" stroke="#34D399" strokeWidth="1" strokeDasharray="4 4" />
          <line x1="209" y1="135" x2="290" y2="195" stroke="#60A5FA" strokeWidth="1" strokeDasharray="4 4" />
        </svg>
        <div style={{ position: "absolute", left: "38%", top: "28%" }}><MapPin size={22} color="#2563EB" delay="0s" /></div>
        <div style={{ position: "absolute", left: "58%", top: "45%" }}><MapPin size={18} color="#16A34A" delay="0.6s" /></div>
        <div style={{ position: "absolute", left: "22%", top: "55%" }}><MapPin size={16} color="#0EA5E9" delay="1.2s" /></div>
        <div style={{ position: "absolute", left: "70%", top: "22%" }}><MapPin size={16} color="#8B5CF6" delay="1.8s" /></div>
        <div style={{ position: "absolute", left: "80%", top: "65%" }}><MapPin size={14} color="#F59E0B" delay="2.4s" /></div>
      </div>

      <FloatCard label="Location Score" value="94.2" accent="#60A5FA" delay="0.5s" style={{ top: 20, right: 0 }} />
      <FloatCard label="Market Potential" value="High ↑" accent="#34D399" delay="1s" style={{ bottom: 80, left: -10 }} />
      <FloatCard label="Competitors" value="12 nearby" accent="#FBBF24" delay="1.5s" style={{ bottom: 16, right: 10 }} />
...
export default function HeroSection() {
  return (
    <section
      id="home"
      style={{
        width: "100%", minHeight: "100vh", background: "#040F2E",
    ...
    >
      ...
      >
        <div style={{ animation: "gmFadeUp 0.8s ease both" }}>
          ...
          >
            <span
              style={{
                ...
                display: "inline-block", animation: "gmBlink 2s infinite",
              }}
            />
            <span
              style={{
          ...
          >
            ...
            geospatial data, competitor distribution, and AI driven insights.
          </p>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <Link
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 32px rgba(37,99,235,0.6)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
                (e.currentTarget as HTMLElement).style.boxShadow = "0 0 24px rgba(37,99,235,0.45)";
              }}
            >
              Browse Project
      ...
      <style>{`
        ...
        @keyframes gmFloat  { 0%,100%{transform:translateY(0px)} 50%{transform:translateY(-10px)} }
        ...
        @keyframes gmBounce { 0%,100%{transform:translateX(-50%) translateY(0)} 50%{transform:translateX(-50%) translateY(7px)} }

        @media (max-width: 1024px) {
          .gm-hero-grid { padding: 5.5rem 2.5rem 3.5rem !important; gap: 2rem !important; }
        }

        @media (max-width: 900px) {
          .gm-hero-grid { grid-template-columns: 1fr !important; padding: 5rem 2rem 3rem !important; }
          .gm-map-visual { max-width: 420px; height: 360px; }
        }

        @media (max-width: 640px) {
          .gm-hero-grid { padding: 4rem 1.25rem 2.5rem !important; }
          .gm-map-visual { height: 320px; }
        }

        @media (max-width: 400px) {
          .gm-hero-grid { padding: 3.5rem 1rem 2rem !important; }
          .gm-map-visual { height: 280px; }
        }

        @media (max-width: 360px) {
          .gm-hero-grid { padding: 3rem 0.875rem 1.75rem !important; }
          .gm-map-visual { height: 260px; }
        }
      `}</style>
    </section>
  );
